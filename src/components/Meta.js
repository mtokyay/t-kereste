...
function Meta(props) {
  ...
  const globalMeta = {
    // Site name
    siteName: "Tokyay Kereste | Balıkesir Gönen'de inşaatlık kereste, doğramalık kereste, ithal kereste, ithal lambri, kütük ev, ahşap ev, bunglov, tinyhouse",
  ...
  const defaultPageMeta = {
    // Page title
    title: "Tokyay Kereste | Balıkesir Gönen Kereste",
    // Page description
    description: "Tokyay Kereste, inşaatlık kereste, doğramalık kereste, lambri, deck tahtası, tinyhouse, kütük ev, pergola, üçgen ev, bungalov",
